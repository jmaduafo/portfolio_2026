...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn("font-heading font-sans-medium text-foreground text-xl", className)}
      {...props}
    />
  )
}
